...
export default function OptionsTracker() {
  ...
  const handleRollTrade = (tradeId: string, newExpiration: string, newStrike?: number) => {
  ...
  const handleRemoveTrade = (tradeToRemove: Trade) => {
    ...
    // Reverse collateral impact if applicable
        ...
        <Dialog open={true} onOpenChange={() => setShowActionSummary(false)}>
          <DialogContent className="max-w-md">
            ...
            <div className="space-y-4">
              <div className="bg-muted p-3 rounded-lg space-y-2">
                ...
                <div className="text-sm space-y-1">
                  <div className="flex justify-between">
                    ...
                    <span className="text-red-600">-${actionSummaryData.commission.toFixed(2)}</span>
                  </div>
                  <div className="flex justify-between">
                    <span>Net Cash Impact:</span>
                    <span className={actionSummaryData.cashImpact >= 0 ? "text-green-600" : "text-red-600"}>
              ...
              <div className="flex gap-2">
                <Button onClick={executeAction} className="flex-1 bg-red-600 hover:bg-red-700 text-white">
                  Execute {actionType.charAt(0).toUpperCase() + actionType.slice(1)}
                </Button>
                <Button variant="outline" onClick={() => setShowActionSummary(false)}>
                  Cancel
                </Button>
              </div>
            </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-4 gap-2">
              <Button
                ...
                className={`h-10 ${actionType === "close" ? "bg-black text-white" : "bg-white text-black border-black"}`}
              >
                <X className="w-4 h-4" />
              </Button>
              <Button
                ...
                className={`h-10 ${actionType === "assign" ? "bg-black text-white" : "bg-white text-black border-black"}`}
              >
              ...
              <Button
                ...
                className={`h-10 ${actionType === "roll" ? "bg-black text-white" : "bg-white text-black border-black"}`}
              >
              ...
              <Button
                ...
                className="h-10 bg-white text-black border-black hover:bg-gray-100"
              >
            ...
            <div className="flex gap-2">
              <Button onClick={handleActionConfirm} className="flex-1 bg-red-600 hover:bg-red-700 text-white">
                {actionType.charAt(0).toUpperCase() + actionType.slice(1)}
              </Button>
              <Button variant="outline" onClick={() => setShowRemoveConfirm(true)} className="border-red-600 text-red-600">
                Remove
              </Button>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-xl font-bold">Prina - Premium Income App</h1>
            </div>
            <div className="flex items-center gap-2">
          ...
          <div className="lg:col-span-1 space-y-6">
              ...
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-bold text-lg">{formatCurrency(portfolioValue)}</span>
                  </div>
                  <div className="flex justify-between items-center">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="font-semibold">{formatCurrency(lockedCollateral)}</span>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="text-sm font-medium">Premium Collected</span>
                    <Select value={timeframe} onValueChange={setTimeframe}>
                      <SelectTrigger className="w-16 h-6 text-xs bg-red-600 text-white border-red-600">
                        <SelectValue />
                      </SelectTrigger>
                      <SelectContent>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                {newTrade.type === "Stock" && (
                  <div>
                    <Label htmlFor="stockAction" className="text-xs font-medium">
                      Action
                    </Label>
                    <Select
                ...
                {newTrade.type !== "Stock" && (
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <Label htmlFor="side" className="text-xs font-medium">
                        Side
                      </Label>
                      <Select
                        value={newTrade.side}
                    ...
                    <div>
                      <Label htmlFor="strike" className="text-xs font-medium">
                        Strike
                      </Label>
                      <Input
                        id="strike"
                ...
                <div className="grid grid-cols-2 gap-3">
                  ...
                  <div>
                    <Label htmlFor="commission" className="text-xs font-medium">
                      Commission
                    </Label>
                    <Input
                      id="commission"
                  ...
                  <div className="space-y-2">
                    {newTrade.type === "Call" && (
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="covered" className="text-xs">
                          Covered Call
                        </Label>
                      </div>
                    )}
                    {newTrade.type === "Put" && (
                      <div className="flex items-center space-x-2">
                        ...
                        />
                        <Label htmlFor="secured" className="text-xs">
                          Cash Secured
                        </Label>
                      </div>
                    )}
              ...
              <TabsContent value="positions" className="space-y-6">
                ...
                <Card>
                  <CardHeader className="pb-3">
                    <div className="flex justify-between items-center">
                      ...
                      <div className="flex items-center space-x-2">
                        <Label htmlFor="includePremiums" className="text-sm">
                          Include Premiums
                        </Label>
                        <Switch className="bg-destructive" id="includePremiums" checked={includePremiums} onCheckedChange={setIncludePremiums} />
                      </div>
                    </div>
                  </CardHeader>
                </Card>
                ...
                <div className="grid gap-4">
                  {positions.map((position) => (
                    <Card
                      key={position.symbol}
                      className={`hover:shadow-lg transition-all duration-300 ${animatingTrade ? "animate-pulse" : ""}`}
                    >
                      <CardHeader className="pb-3">
                        <div className="flex justify-between items-center">
                          <CardTitle className="text-lg flex items-center gap-2">
                            {position.symbol}
                            {position.shares > 0 && <Badge variant="outline">{position.shares} shares</Badge>}
                          </CardTitle>
                      ...
                      <CardContent>
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-4">
                          <div>
                            ...
                            <p className="font-semibold">{formatCurrency(position.originalCostBasis)}</p>
                          </div>
                          <div>
                            <p className="text-sm text-muted-foreground">Premiums Received</p>
                            <p className="font-semibold text-green-600">+{formatCurrency(position.premiumsReceived)}</p>
                          </div>
                          <div>
                            <p className="text-sm text-muted-foreground">
                        ...
                        {position.openOptions.length > 0 && (
                          <div>
                            <div className="flex justify-between items-center mb-3">
                              <h4 className="font-semibold">Open Options</h4>
                            ...
                            <div className="space-y-2">
                              {position.openOptions.map((option) => (
                                <div
                                  key={option.id}
                                  className="flex justify-between items-center p-3 bg-secondary/50 rounded-lg hover:bg-secondary/70 transition-colors"
                                >
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      {trades.map((trade) => (
                        <div
                          key={trade.id}
                          className={`flex items-center justify-between p-4 border rounded-lg hover:bg-secondary/50 transition-all duration-300 cursor-pointer ${
                            animatingTrade === trade.id ? "animate-pulse bg-green-50 dark:bg-green-950" : ""
                          }`}
                        ...
                        >
                          <div className="flex items-center gap-4">
                            <Badge
                              ...
                              className="min-w-[60px] justify-center text-white bg-black"
                            >
